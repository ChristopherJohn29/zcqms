	...
	var app = {
		...
		init: function() {
			...
			$('#add_correction').click(function(){
				...
				$html = ''+
				'<tr>'+
					'<td colspan="5"><input type="text" class="form-control correction_text"></td>'+
				...
				$html2 = ''+
				'<tr>'+
					'<td colspan="2"><input type="text" disabled class="form-control correction_text"></td>'+
					'<td><input type="date" disabled class="form-control correction_date" value="'+date.getFullYear()+'-'+date.getMonth()+'-'+date.getDate()+'"></td>'+
					'<td>'+
				...
				$.ajax({
					...
					success: function(r) {
						...
						$.each(r.form2.correction, function(i, v) {
							$html += ''+
							'<tr>'+
								'<td colspan="5"><input type="text" class="form-control correction_text" value="'+v.correction_text+'"></td>'+
