                ...
                $.ajax({
                    ...
                    success: function(r) {
                        ...
                        $.each(r.form2.correction, function(i, v) {
                            ...
                            $html2 += '' + '<tr>' + '<td colspan="1"><textarea disabled class="form-control correction_text" rows="5">' + v.correction_text + '</textarea></td>' + '<td><input type="date" disabled class="form-control correction_date" value="' + v.correction_date + '"></td>' + '<td><button class="close delete-correction"><span aria-hidden="true">×</span></button></td>' + '</tr>';
                            _correction_ind++;
