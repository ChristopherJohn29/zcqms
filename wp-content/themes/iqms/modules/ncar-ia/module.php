	...
	class NCAR_IA_Module {
		...
		function ncar_ia_post_type() {
			$labels = array(
				...
				'edit_item'             => __( 'Edit NCAR Improvement Action', 'textdomain' ),
				'view_item'             => __( 'View NCAR Improvement Action', 'textdomain' ),
				'all_items'             => __( 'All NCAR Improvement Action', 'textdomain' ),
				'search_items'          => __( 'Search NCAR Improvement Action', 'textdomain' ),
				'parent_item_colon'     => __( 'Parent NCAR Improvement Action:', 'textdomain' ),
				'not_found'             => __( 'No NCAR Improvement Action found.', 'textdomain' ),
				'not_found_in_trash'    => __( 'No NCAR Improvement Action found in Trash.', 'textdomain' ),
				'featured_image'        => _x( 'NCAR Improvement Action Cover Image', 'Overrides the “Featured Image” phrase for this post type. Added in 4.3', 'textdomain' ),
				...
				'insert_into_item'      => _x( 'Insert into NCAR Improvement Action', 'Overrides the “Insert into post”/”Insert into page” phrase (used when inserting media into a post). Added in 4.4', 'textdomain' ),
				'uploaded_to_this_item' => _x( 'Uploaded to this NCAR Improvement Action', 'Overrides the “Uploaded to this post”/”Uploaded to this page” phrase (used when viewing media attached to a post). Added in 4.4', 'textdomain' ),
				'filter_items_list'     => _x( 'Filter NCAR Improvement Action list', 'Screen reader text for the filter links heading on the post type listing screen. Default “Filter posts list”/”Filter pages list”. Added in 4.4', 'textdomain' ),
				'items_list_navigation' => _x( 'NCAR Improvement Action list navigation', 'Screen reader text for the pagination heading on the post type listing screen. Default “Posts list navigation”/”Pages list navigation”. Added in 4.4', 'textdomain' ),
				'items_list'            => _x( 'NCAR Improvement Action list', 'Screen reader text for the items list heading on the post type listing screen. Default “Posts list”/”Pages list”. Added in 4.4', 'textdomain' ),
			);
		...
		function ncar_ia_main_module() {
			...
			add_menu_page(
				__( 'NCAR Improvement Action', 'my-textdomain' ),
				__( 'NCAR Improvement Action', 'my-textdomain' ),
				'create_posts',
				'ncar-ia',
