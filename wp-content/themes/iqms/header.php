        ...
        <div id="masthead" style="background: #b9d1a5 url(/)  center center; ">
            <div id="logo" class="row">
                    ...
                    <a href="https://home.zcmc.ph/">
                        <img src="<?=get_stylesheet_directory_uri()?>/images/site-banner.png" alt="Site Logo" title="Zamboanga City Medical Center" style="text-align:left;">
                    </a>
...
/*
                            ...
                            <nav class="nav">
                               <div class="main-nav">
                                  ...
                                  <li class="menu-item"  style="text-transform:none;"><a href="https://home.zcmc.ph/"  style="text-transform:none;"><h1 style="font-size:5rem;">Home</h1></a></li>
                                  </ul>
                               </div>
                            </nav>
